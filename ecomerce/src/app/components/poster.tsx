    ...
    return (
        <article className="flex flex-col">
            ...
            <section className="relative flex flex-row w-full items-center z-2">
                ...
                <img onClick={() => console.log(`Clicou`)} className={`w-full h-96 object-cover ${cont == 2 || cont == 3? 'object-top' : 'object-center'}`} src={`./images/image-product-${cont}.jpg`} alt="Imagem do Tênis" />
